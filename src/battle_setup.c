...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_THALIA] = REMATCH(TRAINER_THALIA_1, ABANDONED_SHIP_ROOMS2_1F),
    ...
    [REMATCH_VITO] = REMATCH(TRAINER_VITO_1, TRAINER_VITO_2, TRAINER_VITO_3, TRAINER_VITO_4, VICTORY_ROAD_1F),
    [REMATCH_LEAF] = REMATCH(TRAINER_LEAF_1, TRAINER_LEAF_2, TRAINER_LEAF_3, TRAINER_LEAF_4, VICTORY_ROAD_1F),
    ...
    [REMATCH_KIRA_AND_DAN] = REMATCH(TRAINER_KIRA_AND_DAN_1, ABANDONED_SHIP_ROOMS2_1F),
