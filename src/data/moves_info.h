...
const struct MoveInfo gMovesInfo[MOVES_COUNT_ALL] =
{
    ...
    [MOVE_ABSORB] =
    {
        ...
        .type = TYPE_GRASS,
        .accuracy = 100,
        .pp = B_UPDATED_MOVE_DATA >= GEN_4 ? 35 : 20,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_SPECIAL,
    ...
    [MOVE_DIG] =
    {
        ...
        .effect = EFFECT_SEMI_INVULNERABLE,
        .power = B_UPDATED_MOVE_DATA >= GEN_4 ? 120 : 60,
        .type = TYPE_GROUND,
        .accuracy = 100,
        .pp = 10,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_DEFENSE_CURL] =
    {
        .name = COMPOUND_STRING("Defence Curl"),
        .description = COMPOUND_STRING(
            "Curls up to conceal weak\n"
            "spots and raise Defence."),
    ...
    [MOVE_SMOG] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_6 ? 45 : 20,
        .type = TYPE_POISON,
        .accuracy = 95,
        .pp = 30,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_SKULL_BASH] =
    {
        ...
        .effect = EFFECT_TWO_TURNS_ATTACK,
        .power = B_UPDATED_MOVE_DATA >= GEN_6 ? 140 : 100,
        .type = TYPE_STEEL,
        .accuracy = 100,
    ...
    [MOVE_CRABHAMMER] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "high critical-hit ratio."),
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_6 ? 110 : 90,
        .type = TYPE_WATER,
    ...
    [MOVE_RAPID_SPIN] =
    {
        ...
        .power = B_UPDATED_MOVE_DATA >= GEN_8 ? 40 : 20,
        .type = TYPE_NORMAL,
        .accuracy = 100,
        .pp = 35,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_ROCK_SMASH] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "that may lower Defence."),
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_4 ? 65 : 20,
        .type = TYPE_FIGHTING,
        .accuracy = 100,
        .pp = 15,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_SMELLING_SALTS] =
    {
        ...
        .power = B_UPDATED_MOVE_DATA >= GEN_6 ? 120 : 60,
        .type = TYPE_PSYCHIC,
        .accuracy = 100,
        .pp = 5,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_OVERHEAT] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_6 ? 140 : 140,
        .type = TYPE_FIRE,
        .accuracy = 90,
        .pp = 5,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_ROCK_TOMB] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_6 ? 75 : 50,
        .type = TYPE_ROCK,
        .accuracy = B_UPDATED_MOVE_DATA >= GEN_6 ? 100 : 80,
    ...
    [MOVE_IRON_DEFENSE] =
    {
        .name = COMPOUND_STRING("Iron Defence"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DRAIN_PUNCH] =
    {
        ...
        .type = TYPE_FIGHTING,
        .accuracy = 100,
        .pp = B_UPDATED_MOVE_DATA >= GEN_5 ? 15 : 5,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .argument = { .absorbPercentage = 50 },
    ...
    [MOVE_HEX] =
    {
        ...
        .effect = EFFECT_DOUBLE_POWER_ON_ARG_STATUS,
        .power = B_UPDATED_MOVE_DATA >= GEN_6 ? 45 : 50,
        .type = TYPE_GHOST,
        .accuracy = 100,
        .pp = 15,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_BITTER_MALICE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "Lowers the foe's Attack."),
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_9 ? 85 : 60,
        .type = TYPE_GHOST,
        .accuracy = 100,
        .pp = 15,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_NIGHT_TERROR] =
    {
        .name = COMPOUND_STRING("Night Terror"),
        .description = COMPOUND_STRING(
            "A terrifying imaget hat\n"
            "will remove stat changes."),
        .effect = EFFECT_HIT,
        .power = 110,
        .type = TYPE_GHOST,
        .accuracy = 90,
   ...
   [MOVE_AQUA_CHOMP] =
    {
        .name = COMPOUND_STRING("Aqua Chomp"),
        .description = COMPOUND_STRING(
            "A biting attack that\n"
            "that stops fleeing."),
        .effect = EFFECT_HIT,
        .power = 85,
        .type = TYPE_WATER,
    ...
    [MOVE_SAND_DASH] =
    {
        .name = COMPOUND_STRING("Sand Dash"),
        .description = COMPOUND_STRING(
            "The user dashes across\n"
            "the sand, hit's first."),
        .effect = EFFECT_HIT,
        .power = 40,
        .type = TYPE_GROUND,
        .accuracy = 100,
    ...
    [MOVE_SEPTIC_SLAM] =
    {
        .name = COMPOUND_STRING("Septic Slam"),
        .description = COMPOUND_STRING(
            "A venomous attack that\n"
            "may poison or paralyse."),
        .effect = EFFECT_HIT,
        .power = 120,
        .type = TYPE_POISON,
        .accuracy = 85 ,
    ...
    [MOVE_POLAR_VORTEX] =
    {
        .name = COMPOUND_STRING("Polar Vortex"),
        .description = COMPOUND_STRING(
            "A powerful Polarstorm\n"
            "may slow the target."),
        .effect = EFFECT_TWO_TYPED_MOVE,
        .power = 100,
        .type = TYPE_FLYING,
    ...
    [MOVE_WATER_PUNCH] =
    {
        .name = COMPOUND_STRING("Water Punch"),
        .description = COMPOUND_STRING(
            "A punch that may cause\n"
    ...
    [MOVE_JEALOUS_FIT] =
    {
        .name = COMPOUND_STRING("Jealous Fit"),
        .description = COMPOUND_STRING(
            "Does more damage if the\n"
            "foe has powered up."),
        .effect = EFFECT_PUNISHMENT,
    ...
    [MOVE_DIAMOND_FLASH] =
    {
        .name = COMPOUND_STRING("Diamond Flash"),
        .description = COMPOUND_STRING(
            "Diamonds are used to\n"
            "refract light. May lower accuracy."),
        .effect = EFFECT_HIT,
        .power = 110,
        .type = TYPE_ROCK,
        .accuracy = 90,
