...
const struct SpeciesInfo gSpeciesInfoGen3[] =
{
    ...
    [SPECIES_MUDKIP] =
    {
        ...
        .abilities = { ABILITY_TORRENT, ABILITY_DAMP, ABILITY_WATER_BUBBLE },
    ...
    [SPECIES_POOCHYENA] =
    {
        ...
        .abilities = { ABILITY_OWN_TEMPO, ABILITY_QUICK_FEET, ABILITY_RATTLED },
    #else
    ...
    [SPECIES_MIGHTYENA] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 40, SPECIES_STEINULFUR}),
    },
    ...
    [SPECIES_STEINULFUR] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_TOUGH_CLAWS, ABILITY_TOUGH_CLAWS, ABILITY_STRONG_JAW },
    #else
        .abilities = { ABILITY_RUN_AWAY, ABILITY_NONE, ABILITY_RATTLED },
    #endif
        .bodyColor = BODY_COLOR_GRAY,
        .speciesName = _("Steinulfur"),
        .cryId = CRY_LYCANROC_DUSK,
        .natDexNum = NATIONAL_DEX_STEINULFUR,
        .categoryName = _("Bite"),
        .height = 15,
        .weight = 200,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_PELIPPER] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 40, SPECIES_ADMIRATROSS}),
    },
    ...
    [SPECIES_ADMIRATROSS] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_AIR_LOCK, ABILITY_DRIZZLE, ABILITY_RAIN_DISH },
    #else
        .abilities = { ABILITY_AIR_LOCK, ABILITY_DRIZZLE, ABILITY_RAIN_DISH },
    #endif
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Admiratross"),
        .cryId = CRY_KILOWATTREL,
        .natDexNum = NATIONAL_DEX_ADMIRATROSS,
        .categoryName = _("Ablatross"),
        .height = 15,
        .weight = 300,
        .description = COMPOUND_STRING(
            "Its wings are so great that it can\n"
            "use the thermal winds to fly endlessly.\n"
            "They have been known to circumnavigate,\n"
            "the earth three times in a year."),
        .pokemonScale = 256,
        .pokemonOffset = 19,
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_Admiratross,
        .frontPicSize = P_GBA_STYLE_SPECIES_GFX ? MON_COORDS_SIZE(40, 40) : MON_COORDS_SIZE(48, 48),
        .frontPicYOffset = P_GBA_STYLE_SPECIES_GFX ? 12 : 11,
        .frontAnimId = ANIM_V_SHAKE,
        .backPic = gMonBackPic_Admiratross,
        .backPicSize = MON_COORDS_SIZE(64, 56),
        .backPicYOffset = 6,
        .backAnimId = BACK_ANIM_CONVEX_DOUBLE_ARC,
        ...
        .levelUpLearnset = sAdmiratrossLevelUpLearnset,
        .teachableLearnset = sPelipperTeachableLearnset,
    },
...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_GALLADE] =
    {
        ...
        .baseSpAttack  = 65,
        .baseSpDefense = 115,
        .types = MON_TYPES(TYPE_FIGHTING, RALTS_FAMILY_TYPE2),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 259,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
    ...
    [SPECIES_MASQUERAIN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_BUG),
        .abilities = { ABILITY_INTIMIDATE, ABILITY_DRIZZLE, ABILITY_LEVITATE },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_WHISMUR] =
    {
        ...
        .abilities = { ABILITY_SOUNDPROOF, ABILITY_LIQUID_VOICE, ABILITY_RATTLED },
    ...
    [SPECIES_LOUDRED] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_FIELD),
        .abilities = { ABILITY_SOUNDPROOF, ABILITY_LIQUID_VOICE, ABILITY_SCRAPPY },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_LIQUID_VOICE, ABILITY_NORMALIZE, ABILITY_WONDER_SKIN },
    #else
    ...
    [SPECIES_MEDITITE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_PURE_POWER, ABILITY_GOLDEN_BOOT, ABILITY_TELEPATHY },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_ELECTRIKE] =
    {
        ...
        .evYield_Speed = 1,
        .itemCommon = ITEM_MANECTITE,
        .itemRare = ITEM_MANECTITE,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 20,
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_SLOW,
    ...
    [SPECIES_CARVANHA] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 30, SPECIES_SHARPEDO},
                                {EVO_ITEM, ITEM_SUN_STONE, SPECIES_BRUXISH}),
    },
    ...
    [SPECIES_TORKOAL] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_DAWN_STONE, SPECIES_TURTONATOR}),
    },
    ...
    [SPECIES_CACNEA] =
    {
        ...
        .abilities = { ABILITY_SAND_VEIL, ABILITY_WATER_ABSORB, ABILITY_STORM_DRAIN },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_SWABLU] =
    {
        ...
        .evYield_SpDefense = 1,
        .itemCommon = ITEM_ALTARIANITE,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 20,
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_NATURAL_CURE, ABILITY_LIQUID_VOICE, ABILITY_CLOUD_NINE },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_SEVIPER] =
    {
        ...
        .abilities = { ABILITY_SHED_SKIN, ABILITY_INFILTRATOR, ABILITY_INFILTRATOR },
        .bodyColor = BODY_COLOR_BLACK,
        .noFlip = TRUE,
    ...
    [SPECIES_DUSKULL] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
    #if P_UPDATED_ABILITIES >= GEN_6
        .abilities = { ABILITY_CURSED_BODY, ABILITY_PRESSURE, ABILITY_BAD_DREAMS },
    #else
        .abilities = { ABILITY_LEVITATE, ABILITY_NONE, ABILITY_NONE },
    #endif
        .bodyColor = BODY_COLOR_BLACK,
    ...
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_RAIN_DISH, ABILITY_HARVEST },
    #else
    ...
    [SPECIES_SNORUNT] =
    {
        ...
        .evYield_HP = 1,
        .itemCommon = ITEM_GLALITITE,    
        .itemRare = ITEM_FROSLASSITE,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 20,
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_MEDIUM_FAST,
    ...
    [SPECIES_FROSLASS] =
    {
        ...
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 168 : 187,
        .evYield_Speed = 2,
        .itemCommon = ITEM_FROSLASSITE,               
        .genderRatio = MON_FEMALE,
        .eggCycles = 20,
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY, EGG_GROUP_MINERAL),
        .abilities = { ABILITY_SNOW_CLOAK, ABILITY_LIQUID_VOICE, ABILITY_CURSED_BODY },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_CLAMPERL] =
    {
        ...
        .abilities = { ABILITY_SHELL_ARMOR, ABILITY_RATTLED, ABILITY_RATTLED },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_SALAMENCE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_DRAGON),
        .abilities = { ABILITY_INTIMIDATE, ABILITY_MOXIE, ABILITY_AERILATE },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_DEOXYS_NORMAL] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_PRESSURE, ABILITY_DOWNLOAD, ABILITY_DOWNLOAD },
        .bodyColor = BODY_COLOR_RED,
