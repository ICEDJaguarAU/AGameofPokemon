...
{//                   Defender -->
 //  Attacker           None   Normal Fighting Flying  Poison  Ground   Rock    Bug     Ghost   Steel  Mystery  Fire   Water   Grass  Electric Psychic   Ice   Dragon   Dark   Fairy   Stellar
    ...
    [TYPE_GHOST]    = {______, X(0.0), X(2.0), ______, ______, ______, ______, ______, X(2.0), STL_RS, ______, ______, ______, X(0.5), ______, PSY_RS, ______, X(0.5), X(0.5), X(2.0), ______},
    ...
    [TYPE_PSYCHIC]  = {______, ______, X(2.0), X(2.0), X(2.0), ______, ______, X(0.5), X(0.5), X(0.5), ______, ______, ______, ______, ______, X(0.5), ______, ______, X(0.0), X(0.5), ______},
