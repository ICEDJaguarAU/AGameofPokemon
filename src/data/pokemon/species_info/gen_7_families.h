...
const struct SpeciesInfo gSpeciesInfoGen7[] =
{
    ...
    [SPECIES_DARTRIX] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 34, SPECIES_DECIDUEYE},
                                {EVO_ITEM, ITEM_LEAF_STONE, SPECIES_DECIDUEYE_HISUI}),
    },
    ...
    [SPECIES_POPPLIO] =
    {
        ...
        .abilities = { ABILITY_TORRENT, ABILITY_MISTY_SURGE, ABILITY_MISTY_SURGE },
    ...
    [SPECIES_ROCKRUFF] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 22, SPECIES_AETHELWULF}),
    },
    ...
    [SPECIES_AETHELWULF] =
    {
        ...
        .bodyColor = BODY_COLOR_GRAY,
        .speciesName = _("Aethelwulf"),
        .cryId = CRY_LYCANROC_MIDDAY,
        .natDexNum = NATIONAL_DEX_AETHELWULF,
        .categoryName = _("Wolf"),
        .height = 8,
        .weight = 250,
        .description = COMPOUND_STRING(
            ...
            "then slices them with the teeth\n"),
        .pokemonScale = 366,
        .pokemonOffset = 7,
        .trainerScale = 257,
        .trainerOffset = 0,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 44, SPECIES_VARGKOENIG}),
    },
    ...
    [SPECIES_VARGKOENIG] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_INTIMIDATE, ABILITY_STRONG_JAW, ABILITY_TOUGH_CLAWS },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Vargkoenig"),
        .cryId = CRY_LYCANROC_MIDNIGHT,
        .natDexNum = NATIONAL_DEX_VARGKOENIG,
        .categoryName = _("Wolf lord"),
        .height = 18,
        .weight = 500,
        .description = COMPOUND_STRING(
            "This Pokémon uses its teeth and claws\n"
            "to attack any who approach. It will\n"
    ...
    [SPECIES_FOMANTIS] =
    {
        ...
        .abilities = { ABILITY_LEAF_GUARD, ABILITY_CONTRARY, ABILITY_CONTRARY },
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_PALOSSAND] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_WATER_COMPACTION, ABILITY_SAND_VEIL, ABILITY_SAND_VEIL },
        .bodyColor = BODY_COLOR_BROWN,
...
#define MINIOR_CORE_SPECIES_INFO(Form, color, iconPal)          \
    ...
    [SPECIES_TURTONATOR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_SHELL_ARMOR, ABILITY_DROUGHT, ABILITY_IRON_BARBS },
        .bodyColor = BODY_COLOR_RED,
