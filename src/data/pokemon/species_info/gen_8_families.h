...
const struct SpeciesInfo gSpeciesInfoGen8[] =
{
    ...
    [SPECIES_SCORBUNNY] =
    {
        ...
        .abilities = { ABILITY_BLAZE, ABILITY_LIBERO, ABILITY_LIBERO },
    ...
    [SPECIES_RABOOT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_BLAZE, ABILITY_LIBERO, ABILITY_GOLDEN_BOOT },
    ...
    [SPECIES_YAMPER] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_BALL_FETCH, ABILITY_RATTLED, ABILITY_RATTLED },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_ARROKUDA] =
    {
        ...
        .abilities = { ABILITY_SWIFT_SWIM, ABILITY_PROPELLER_TAIL, ABILITY_PROPELLER_TAIL },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_TOXTRICITY_AMPED] =
    {
        ...
        .abilities = { ABILITY_PUNK_ROCK, ABILITY_SOUNDPROOF, ABILITY_TECHNICIAN },
        .bodyColor = BODY_COLOR_PURPLE,
...
#define ALCREMIE_REGULAR_SPECIES_INFO(sweet, cream, color)                                      \
    ...
    [SPECIES_FROSMOTH] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SHIELD_DUST, ABILITY_SLUSH_RUSH, ABILITY_ICE_SCALES },
        .bodyColor = BODY_COLOR_WHITE,
