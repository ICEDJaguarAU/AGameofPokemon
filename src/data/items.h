...
static const u8 sGarchompDesc[]     = _("This stone enables\n"
                                          "Garchomp to Mega\n"
                                          "Evolve in battle.");
                                          
static const u8 sLucarioDesc[]     = _("This stone enables\n"
                                          "Lucario to Mega\n"
                                          "Evolve in battle.");                                          
...
// Mega Stones
    ...
    [ITEM_GARCHOMPITE_Z] =
    {
        ...
        .pluralName = _("Garchompites Z"),
        .price = 0,
        .holdEffect = HOLD_EFFECT_MEGA_STONE,
        .description = sGarchompDesc,
        .pocket = POCKET_ITEMS,
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .flingPower = 80,
    ...
    [ITEM_LUCARIONITE_Z] =
    {
        ...
        .pluralName = _("Lucarionites Z"),
        .price = 0,
        .holdEffect = HOLD_EFFECT_MEGA_STONE,
        .description = sLucarioDesc,
        .pocket = POCKET_ITEMS,
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .flingPower = 80,
...
// TMs/HMs. They don't have a set flingPower, as that's handled by GetFlingPowerFromItemId.
    ...
    [ITEM_TM_TERRAIN_PULSE] =
    {
        ...
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
        .secondaryId = MOVE_TERRAIN_PULSE, // Todo
    },
    ...
    [ITEM_TM_SPIRIT_SHACKLE] =
    {
        ...
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
        .secondaryId = MOVE_SPIRIT_SHACKLE, // Todo
    },
    ...
    [ITEM_TM_DIAMOND_FLASH] =
    {
        ...
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
        .secondaryId = MOVE_DIAMOND_FLASH, // Todo
    },
    ...
    [ITEM_TM_SAND_DASH] =
    {
        ...
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
        .secondaryId = MOVE_SAND_DASH, // Todo
    },
