...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_TYPHLOSION_HISUI] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_BLAZE, ABILITY_FRISK, ABILITY_FRISK },
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Typhlosion"),
        .cryId = CRY_TYPHLOSION,
        .natDexNum = NATIONAL_DEX_TYPHLOSION,
...
#define TOGEPI_FAMILY_TYPE (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_NORMAL)
    ...
    [SPECIES_TOGEPI] =
    {
        ...
        .abilities = { ABILITY_FAIRY_AURA, ABILITY_SERENE_GRACE, ABILITY_SUPER_LUCK },
    ...
    [SPECIES_MAREEP] =
    {
        ...
        .itemCommon = ITEM_AMPHAROSITE,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 20,
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_FIELD),
        .abilities = { ABILITY_STATIC, ABILITY_FUR_COAT, ABILITY_PLUS },
        .bodyColor = BODY_COLOR_WHITE,
...
#define AMPHAROS_DEFENSE (P_UPDATED_STATS >= GEN_6 ? 85 : 75)
    ...
    [SPECIES_YANMEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SPEED_BOOST, ABILITY_TINTED_LENS, ABILITY_LEVITATE },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_MISDREAVUS] =
    {
        ...
        .abilities = { ABILITY_PRANKSTER, ABILITY_MAGIC_BOUNCE, ABILITY_MAGIC_BOUNCE },
...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    ...
    [SPECIES_HERACROSS] =
    {
        ...
        .itemCommon = ITEM_HERACRONITE,
        .itemRare = ITEM_HERACRONITE,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 25,
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_SLOW,
    ...
    [SPECIES_URSALUNA] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_PEAT_BLOCK, SPECIES_URSALUNA_BLOODMOON}),
    ...
    [SPECIES_PILOSWINE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_MOVE, MOVE_ANCIENT_POWER, SPECIES_MAMOSWINE},
                                {EVO_LEVEL, 53, SPECIES_MAMOSWINE}),
    },
    ...
    [SPECIES_MAMOSWINE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SNOW_WARNING, ABILITY_SLUSH_RUSH, ABILITY_THICK_FAT },
        .bodyColor = BODY_COLOR_BROWN,
...
#define CORSOLA_DEFENSES (P_UPDATED_STATS >= GEN_7 ? 95 : 85)
    ...
    [SPECIES_HOUNDOUR] =
    {
        ...
        .itemCommon = ITEM_HOUNDOOMINITE,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 20,
        .friendship = 35,
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_DARK_AURA, ABILITY_FLASH_FIRE, ABILITY_UNNERVE },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_DONPHAN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_STURDY, ABILITY_SAND_VEIL, ABILITY_SAND_VEIL },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_STANTLER] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_INTIMIDATE, ABILITY_GOLDEN_BOOT, ABILITY_SAP_SIPPER },
    #else
    ...
    [SPECIES_RAIKOU] =
    {
        ...
        .abilities = { ABILITY_PRESSURE, ABILITY_LIGHTNING_ROD, ABILITY_INNER_FOCUS },
    #else
    ...
    [SPECIES_SUICUNE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
    #if P_UPDATED_ABILITIES >= GEN_7
        .abilities = { ABILITY_PRESSURE, ABILITY_STORM_DRAIN, ABILITY_INNER_FOCUS },
    #else
    ...
    [SPECIES_LARVITAR] =
    {
        ...
        .abilities = { ABILITY_GUTS, ABILITY_SAND_RUSH, ABILITY_SAND_VEIL },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_PUPITAR] =
    {
        ...
        .expYield = 144,
        .itemCommon = ITEM_TYRANITARITE,
        .itemRare = ITEM_TYRANITARITE,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 40,
        .friendship = 35,
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER),
        .abilities = { ABILITY_SHED_SKIN, ABILITY_SAND_RUSH, ABILITY_SHED_SKIN },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_TYRANITAR] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER),
        .abilities = { ABILITY_SAND_STREAM, ABILITY_UNNERVE, ABILITY_UNNERVE },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_LUGIA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_PRESSURE, ABILITY_CLOUD_NINE, ABILITY_MULTISCALE },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Lugia"),
        .cryId = CRY_LUGIA,
    ...
    [SPECIES_HO_OH] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_PRESSURE, ABILITY_CLOUD_NINE, ABILITY_REGENERATOR },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Ho-Oh"),
        .cryId = CRY_HO_OH,
    ...
    [SPECIES_CELEBI] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_NATURAL_CURE, ABILITY_CHLOROPHYLL, ABILITY_SERENE_GRACE },
        .bodyColor = BODY_COLOR_GREEN,
