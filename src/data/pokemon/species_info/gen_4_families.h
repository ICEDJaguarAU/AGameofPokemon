...
const struct SpeciesInfo gSpeciesInfoGen4[] =
{
    ...
    [SPECIES_CHIMCHAR] =
    {
        ...
        .abilities = { ABILITY_BLAZE, ABILITY_GRASSY_SURGE, ABILITY_GRASSY_SURGE },
    ...
    [SPECIES_PIPLUP] =
    {
        ...
        .abilities = { ABILITY_TORRENT, ABILITY_SNOW_WARNING, ABILITY_SNOW_WARNING },
    #else
    ...
    [SPECIES_KRICKETUNE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SWARM, ABILITY_TECHNICIAN, ABILITY_TECHNICIAN },
        .bodyColor = BODY_COLOR_RED,
...
#define MOTHIM_SPECIES_INFO                                                 \
    ...
    [SPECIES_BUNEARY] =
    {
        ...
        .itemCommon = ITEM_LOPUNNITE,
        .itemRare = ITEM_LOPUNNITE,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 20,
        .friendship = 0,
        .growthRate = GROWTH_MEDIUM_FAST,
    ...
    [SPECIES_LOPUNNY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_CUTE_CHARM, ABILITY_GOLDEN_BOOT, ABILITY_LIMBER },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_SPIRITOMB] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_PRESSURE, ABILITY_INFILTRATOR, ABILITY_INFILTRATOR },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_GIBLE] =
    {
        ...
        .itemCommon = ITEM_GARCHOMPITE,
        .itemRare = ITEM_GARCHOMPITE,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 40,
        .friendship = STANDARD_FRIENDSHIP,
    ...
    [SPECIES_RIOLU] =
    {
        ...
        .itemCommon = ITEM_LUCARIONITE,
        .itemRare = ITEM_LUCARIONITE,
        .genderRatio = PERCENT_FEMALE(12.5),
        .eggCycles = 25,
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_MEDIUM_SLOW,
    ...
    [SPECIES_HIPPOPOTAS] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SAND_STREAM, ABILITY_SAND_RUSH, ABILITY_SAND_FORCE },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_CARNIVINE] =
    {
        ...
        .abilities = { ABILITY_RAIN_DISH, ABILITY_GLUTTONY, ABILITY_GLUTTONY },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_SNOVER] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_GRASS),
        .abilities = { ABILITY_SNOW_WARNING, ABILITY_SOUNDPROOF, ABILITY_SOUNDPROOF },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_DIALGA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_PRESSURE, ABILITY_TELEPATHY, ABILITY_TELEPATHY },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_HEATRAN] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_FLASH_FIRE, ABILITY_HEAVY_METAL, ABILITY_FLAME_BODY },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_REGIGIGAS] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_SLOW_START, ABILITY_NONE, ABILITY_CLOUD_NINE },
        .bodyColor = BODY_COLOR_WHITE,
